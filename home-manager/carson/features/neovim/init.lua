--[[
The goal here is to move all the parts I like from the kickstart config up here
Then I will have my own complete config and can delete all the rest
--]]
...
-- Enable telescope fzf native & projects extensions 
pcall(require('telescope').load_extension, 'fzf')
pcall(require('telescope').load_extension, 'projects')

-- Fuzzy search in current buffer
vim.keymap.set('n', '<leader>/', function()
  -- Additional configuration to show a smaller telescope box.
